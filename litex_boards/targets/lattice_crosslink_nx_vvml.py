...
from litex_boards.platforms import crosslink_nx_vvml
...
class BaseSoC(SoCCore):
    ...
    def __init__(self, sys_clk_freq=int(75e6), hyperram="none", toolchain="radiant",
        ...
        platform = crosslink_nx_vvml.Platform(toolchain=toolchain)
        ...
        SoCCore.__init__(self, platform, sys_clk_freq, ident="LiteX SoC on Crosslink-NX Voice and Vision Machine Learning Board", **kwargs)
...
def main():
    ...
    parser = LiteXSoCArgumentParser(description="LiteX SoC on Crosslink-NX VVML Board")
